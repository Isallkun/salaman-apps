    ...
    <section id="cara-kerja" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-emerald-50 via-white to-emerald-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-12 text-center">
          <Link 
            href="/auth/register"
            className="inline-block bg-emerald-500 hover:bg-emerald-600 text-white px-10 py-4 rounded-xl font-bold text-lg shadow-lg shadow-emerald-500/30 transition-all hover:shadow-xl hover:scale-105"
          >
